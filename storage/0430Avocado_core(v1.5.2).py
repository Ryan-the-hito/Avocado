...
from PyQt6.QtWidgets import (QWidget, QPushButton, QApplication,
                             QLabel, QHBoxLayout, QVBoxLayout, QLineEdit, QSystemTrayIcon, QMenu, QComboBox)
...
class window0(QWidget):  # 增加说明页面
    ...
    def initUI(self):  # 说明页面内信息
        lbl = QLabel('''
                ...
                Contact: 
                dpye2hmpivcwqrvg@hideaddress.net''', self)
        lbl.move(20, 15)
        self.resize(400, 350)
        self.center()
...
class window1(QWidget):  # 增加客制化替换窗口
    def __init__(self):
        super().__init__()
    ...
    def initUI(self):  # 设置窗口内布局
        ...
        self.le1.move(115, 65)

        self.le2 = QLineEdit(self)
        self.le2.resize(135, 25)
        self.le2.move(115, 115)

        widget0 = QComboBox(self)
        widget0.addItems(['Original', '大陆简体', '台灣正體', '香港繁體', '马新简体'])
        widget0.currentIndexChanged.connect(self.index_changed)
        widget0.resize(135, 25)
        widget0.move(115, 165)
