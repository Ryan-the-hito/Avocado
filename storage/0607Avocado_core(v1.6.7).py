...
class window1(QWidget):  # 增加客制化替换窗口，也是主程序的代码块
    ...
    def initUI(self):  # 设置窗口内布局
        ...
        # self.le1.setStyleSheet("border-radius:4px; border: 1px solid gray;")

        self.le2 = QLineEdit(self)
        self.le2.resize(135, 25)
        self.le2.move(115, 110)
        self.le2.setPlaceholderText('Enter your text')
        # self.le2.setStyleSheet("border-radius:4px; border: 1px solid gray;")
...
class window2(QWidget):  # 增加更新页面
    ...
    def initUI(self):  # 说明页面内信息
        ...
        lbl = QLabel('Current Version: 1.6.7', self)
        lbl.move(110, 75)
