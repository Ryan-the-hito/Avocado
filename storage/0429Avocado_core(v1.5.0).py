...
from PyQt6.QtWidgets import (QWidget, QPushButton, QApplication,
                             QLabel, QHBoxLayout, QVBoxLayout, QLineEdit, QSystemTrayIcon, QMenu)
...
class window1(QWidget):  # 增加客制化替换窗口
    ...
    def initUI(self):  # 设置窗口内布局
        ...
        self.le1.move(120, 65)

        self.le2 = QLineEdit(self)
        self.le2.resize(135, 25)
        self.le2.move(120, 115)
    ...
    def cusrep(self):  # 设置 menu bar 中"Replacement Customization"的功能
        a = pyperclip.paste()
        new = self.le1.text()
        old = self.le2.text()
        a = self.default_clean(a)
    ...
    def default_clean(self, a): # 两个功能所依赖的基本功能块
